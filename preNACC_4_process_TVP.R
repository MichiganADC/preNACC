...
write_csv(df_tvp, 
          paste0(path_nacc_push_today, 
                 "/NACC_UDS3_tvp_", today_char, ".csv"), 
          na = "")

write_csv(df_tvp_block,
          paste0(path_nacc_push_today, 
                 "/BLOCKED_NACC_UDS3_tvp_", today_char, ".csv"), 
          na = "")
...
ncltr_cmd_1 <- paste0(
  ...
  "< ", path_nacc_push_today, "/NACC_UDS3_tvp_", today_char, ".csv",
  "> ", path_nacc_push_today, "/NACC_UDS3_tvp_", today_char, "_FILTERED.csv"
)
system(ncltr_cmd_1)
...
ncltr_cmd_2 <- paste0(
  ...
  "python3 ", ncltr_path, "/nacc/redcap2nacc.py ",
  "-tfp ",
  "-file ", path_nacc_push_today, "/NACC_UDS3_tvp_", today_char, "_FILTERED.csv",
  "> ", path_nacc_push_today, "/NACC_UDS3_tvp_", today_char, ".txt"
)
system(ncltr_cmd_2)
